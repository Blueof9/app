...
const DepositModal: React.FC<DepositModalProps> = ({ max, onConfirm, onDismiss, tokenName = '', isMMS }) => {
  ...
  return (
    <Modal>
      <ModalTitle text={!isMMS ? `Deposit ${tokenName} Tokens` : 'Convert MMS to KtKt'} />
      <TokenInput
        value={val}
