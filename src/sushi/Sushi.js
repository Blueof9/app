...
export class Sushi {
  constructor(provider, networkId, testing, options) {
    ...
    this.MMSAddress = contractAddresses.MMS[networkId]
    this.MMSMaster = contractAddresses.MMSMaster[networkId]
	this.wbusdAddress = contractAddresses.wbusd[networkId]
	this.BNBBUSDPair = contractAddresses.BNBBUSDPair[networkId]
	this.MMSBNBPair = contractAddresses.MMSBNBPair[networkId]
	this.KtKtBNBPair = contractAddresses.KtKtBNBPair[networkId]
	this.BUSDUSDTPair = contractAddresses.BUSDUSDTPair[networkId]
	this.KtKtMMSPair = contractAddresses.KtKtMMSPair[networkId]
  }
